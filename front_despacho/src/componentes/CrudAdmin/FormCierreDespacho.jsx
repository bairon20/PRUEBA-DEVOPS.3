...
export const FormCierreDespacho = ({ despacho, onClose }) => {
  ...
  const isEntregado = Boolean(despacho.entregado);

  const onSubmit = async (data) => {
    console.log("onSubmit ejecutado");
    const jsonData = {
      intento: Number(data.intento),
      entregado: data.despachado === "true" || data.despachado === true,
    };
    ...
    try {
      ...
      Swal.fire({
        title: "Error",
        text: "Hubo un error al modificar el despacho",
        icon: "error",
        confirmButtonText: "Aceptar",
      });
    }
